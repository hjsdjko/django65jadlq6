...
<div :style='{"width":"1200px","padding":"20px","margin":"10px auto 20px","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="用户电话" prop="yonghudianhua">
            <el-input  v-model="ruleForm.yonghudianhua" 
                placeholder="用户电话" clearable :readonly=" false  ||ro.yonghudianhua"></el-input>
          </el-form-item>
