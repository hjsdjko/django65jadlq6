...
<div class="content" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230831/511269159d614e62a63378dfef0a7567.png) no-repeat center top / cover","display":"flex","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
	...
	<div :style='{"padding":"0","boxShadow":"0 0px 0px 0px rgba(100,100,100,.05)","margin":"0 0px 30px 0px","borderColor":"#fceaee","alignItems":"center","color":"#666","display":"flex","justifyContent":"center","borderRadius":"3px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","fontSize":"18px","borderStyle":"double","order":"1"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 2% 10px 0","borderColor":"#ceddee","borderRadius":"3px","textAlign":"center","background":"#2aca76","borderWidth":"0px","display":"flex","width":"18%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('remenshipin','首页总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"32px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{remenshipinCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"#fff","height":"24px"}'>热门视频总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 4 -->
	<div class="type4" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"1"}'>
		<div id="remenshipinChart1" class="echarts1" v-if="isAuth('remenshipin','首页统计')"></div>
		<div id="remenshipinChart2" class="echarts2" v-if="isAuth('remenshipin','首页统计')"></div>
		<div id="remenshipinChart3" class="echarts3" v-if="isAuth('remenshipin','首页统计')"></div>
		<div id="remenshipinChart4" class="echarts4" v-if="isAuth('remenshipin','首页统计')"></div>
	</div>
</div>
</template>
<script>
