		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="remenshipinChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="remenshipinChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"10px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"100%","fontSize":"14px","height":"calc(30% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>热门视频总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{remenshipinCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 0px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>热门视频</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="spdz" label="视频地址"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="up" label="up主"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fabudi" label="发布地"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="spsc" label="视频时长"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="leixing" label="类型"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="bofangliang" label="播放量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="dianzanliang" label="点赞量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="toubiliang" label="投币量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="shoucangliang" label="收藏量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fenxiangliang" label="分享量"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="remenshipinChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="remenshipinChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
  ...
  created() {
    this.$nextTick(()=>{
		this.times()
		setTimeout(()=>{
			this.getremenshipinCount();
			this.remenshipinChat1();
			this.remenshipinChat2();
			this.remenshipinChat3();
			this.remenshipinChat4();
		},500)
	})
  },
  methods:{
    ...
    getremenshipinCount() {
        this.$http({
            url: `remenshipin/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.remenshipinCount = data.data
            }
        })
    },
...
//统计接口1
    remenshipinChat1() {
      this.$nextTick(()=>{
        ...
        var remenshipinChart1 = echarts.init(document.getElementById("remenshipinChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                remenshipinChart1.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    remenshipinChart1.resize();
                },false);
            }
        });
      })
...
//统计接口2
    remenshipinChat2() {
      this.$nextTick(()=>{
        ...
        var remenshipinChart2 = echarts.init(document.getElementById("remenshipinChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                remenshipinChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    remenshipinChart2.resize();
                },false);
            }
        });
      })
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'remenshipinChart3');
...
//统计接口4
    remenshipinChat4() {
      this.$nextTick(()=>{
        ...
        var remenshipinChart4 = echarts.init(document.getElementById("remenshipinChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                remenshipinChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    remenshipinChart4.resize();
				},false);
            }
        });
      })
