...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderbz8yt && scrapy crawl "+tableName+"Spider -a databaseName=django65jadlq6"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django65jadlq6"
        os.system(cmd)
